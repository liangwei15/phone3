...
<head>
    ...
    <title>维修服务</title>
    <link rel="stylesheet" type="text/css" href="/phone2/Public/Home/css/First-3.css">
...
<div class="out">
    ...
    <div class="out2">
        ...
        <div class="pic2 pic">
            <img src="/phone2/Public/Home/img/little_01.gif" width="100%" height="100%"/>

            <p class="text1">上门维修</p>
        </div>
        <div class="pic2">
            <img src="/phone2/Public/Home/img/little_02.gif" width="100%" height="100%"/>

            <p class="text">到店维修</p>
        </div>
        <div class="pic2">
            <img src="/phone2/Public/Home/img/little_07.gif" width="100%" height="100%"/>
            <p class="text3">邮寄维修</p>
        </div>
        <div class="pic3">
            <img src="/phone2/Public/Home/img/little_04.gif" width="75%" height="100%"/>
    ...
    <div class="box">
        <div class="box1">
            <img src="/phone2/Public/Home/img/little_001.gif" width="100%" height="100%" class="head"/>
            <p class="flout">请填写您的回寄地址</p><img src="/phone2/Public/Home/img/next.gif" width="100%" height="100%" class="next">
        </div>
        <div style="clear:both"></div>
        <div class="box1">
            <img src="/phone2/Public/Home/img/little_003.gif" width="100%" height="100%" class="head"/>
