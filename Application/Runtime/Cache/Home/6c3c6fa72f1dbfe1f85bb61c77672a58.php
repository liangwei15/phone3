...
<head>
    ...
    <link rel="stylesheet" href="/phone3/Public/Home/css1/odstyle.css" />
...
<div id="center">
    ...
    <div class="zhuangtai">
        <div>
            <p class="huifont2">价格</p> <p class="xiche1">￥<?php echo ($tm["r_allprices"]); ?></p></div>
        <div style="clear: both"></div>
        ...
        <div style="clear: both"></div>
        <div><p class="huifont2">预计需支付</p><p class="xiche1">￥<?php echo ($tm['r_allprices'] - $tm['price']-$tm['r_price']); ?></p></div>
    ...
    <?php if($tm["zhuangtai"] == 1): ?><div class="zhuangtai_1">
        ...
        <button class="bottom_2" type="button" onclick="window.location.href='/phone3/index.php/Home/Index/yuyuejinzhan.html'">返回首页</button>
        <?php else: endif; ?>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body"><form method="post" action="/phone3/index.php/Home/Index/qxdd">
