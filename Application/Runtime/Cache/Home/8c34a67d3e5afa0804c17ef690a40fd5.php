...
<head>
    ...
    <title>维修服务</title>
    <link rel="stylesheet" type="text/css" href="/phone3/Public/Home/css/First-2.css">
        <script>
                function namea() {
...
<body>
<form action="<?php echo U('add_repair2');?>" enctype="multipart/form-data" method="post">
<div class="out">
    ...
    <div class="out2">
        ...
        <div class="pic2" onclick="window.open('/phone3/index.php/Home/Index/First_2?fid=<?php echo ($tm["fid"]); ?>','_self');"  style="width: 33%">
            <img src="/phone3/Public/Home/img/big_005.gif" width="100%" height="100%"/>
        ...
        <!--<div class="pic3" onclick="window.open('/phone3/index.php/Home/Index/First_4?fid=<?php echo ($tm["fid"]); ?>','_self');">-->
            <!--<img src="/phone3/Public/Home/img/little_04.gif" width="63%" height="100%"/>-->
    ...
    <div class="box">
        <div class="box1">
            ...
            <input class="flout" name="name" type="text" id="center_0" placeholder="请输入您的称呼" style="height: 40px;width: 85%"></input>
        ...
        <div style="clear:both"></div>
        <div class="box1">
            <img src="/phone3/Public/Home/img/T3_003.gif" width="100%" height="100%" class="head"/>
            <!--<p class="flout" id="center_3">请选择门店</p><a data-toggle="modal" data-target="#shop" id="returns2">-->
            <input class="flout" name="shop" type="text" id="center_0" placeholder="请选择门店" style="height: 40px;width: 85%"></input>
