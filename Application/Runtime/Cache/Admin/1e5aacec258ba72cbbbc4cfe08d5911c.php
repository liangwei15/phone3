                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tr>
                                    ...
                                    <th class="table-title">手机机型</th>
                                    <th class="table-title">姓名</th>
                                    <th class="table-title">维修价格</th>
                                    <th class="table-title">联系方式</th>
                                    <th class="table-set">优惠</th>
                                    <th class="table-set">兑换码优惠</th>
                                ...
                                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo ($i); ?></td>
                                        <td><a href="#"><?php echo ($vo["brand"]); ?>-<?php echo ($vo["phonename"]); ?></a></td>
                                        <td><a href="#"><?php echo ($vo["r_name"]); ?></a></td>
                                        <td><a href="#"><?php echo ($vo["r_price"]); ?></a></td>
                                        <td><a href="#"><?php echo ($vo["r_tel"]); ?></a></td>
                                        <td><a href="#"><?php echo ($vo["price"]); ?>元</a></td>
                                       <td><a href="#"><?php echo ($vo["c_price"]); ?>元</a></td>
