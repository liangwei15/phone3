                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tr>
                                    ...
                                    <th class="table-title">手机型号</th>
                                    <th class="table-title">姓名</th>

                                    <th class="table-title">价格</th>
                                    <th class="table-title">地址</th>

                                    <th class="table-set">上门时间</th>

                                    <th class="table-set">优惠</th>
                                    <th class="table-set">兑换优惠</th>
                                ...
                                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo ($i); ?></td>
                                        <td><?php echo ($vo["brand"]); ?>-<?php echo ($vo["phonename"]); ?></td>
                                        <td><a href="#"><?php echo ($vo["username"]); ?></a></td>

                                        <td><a href="#"><?php echo ($vo["c_price"]); ?></a></td>
                                        <td><a href="#"><?php echo ($vo["address"]); ?></a></td>
                                        <td><a href="#"><?php echo ($vo["r_shangmentime"]); ?></a></td>
                                        <td><a href="#"><?php echo ($vo["price"]); ?></a></td>
                                        <td><a href="#"><?php echo ($vo["r_price"]); ?></a></td>
                                        <td><a href="#"><?php echo ($vo["r_intro"]); ?></a></td>

                                    <!--    <td><a href="#" data-toggle="modal" data-target="#myModala">点击查看</a> <!--<?php if(is_array($info1)): $i = 0; $__LIST__ = $info1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><a href="#"><?php echo ($vo1["dcname"]); ?></a>*<?php echo ($vo1["num"]); ?><br><?php endforeach; endif; else: echo "" ;endif; ?>--><!-- </td>
