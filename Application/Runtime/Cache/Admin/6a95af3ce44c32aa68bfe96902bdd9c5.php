                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo ($i); ?></td>
                                        <td><a href="#"><?php echo ($vo["brand"]); ?></a></td>
                                        <td>
                                            <div class="am-btn-toolbar">
                                                <div class="am-btn-group am-btn-group-xs">
                                                    <a href="/phone2/index.php/Admin/Index/modellist?id=<?php echo ($vo["b_id"]); ?>"
                                                       class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">

                                                        <span class="am-icon-copy"></span>查看手机型号

                                                    </a>
                                                    <!--<a href="/phone2/index.php/Admin/Index/carmodel?id=<?php echo ($vo["b_id"]); ?>"-->
                                                       <!--class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">-->

                                                        <!--<span class="am-icon-copy"></span>增加手机型号-->

                                                    <!--</a>-->
                                                    <!--<a href="/phone2/index.php/Admin/Index/savebrand?id=<?php echo ($vo["id"]); ?>"-->
                                                       <!--class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">-->

                                                  <!--<span class="am-icon-pencil-square-o"></span>修改手机品牌-->

                                                    <!--</a>-->
                                                    <a href="/phone2/index.php/Admin/Index/delbrand?id=<?php echo ($vo["b_id"]); ?>"
                                                       class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
