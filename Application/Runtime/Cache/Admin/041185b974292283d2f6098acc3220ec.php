...
<head>
  ...
  <link rel="icon" type="image/png" href="/phone2/Public/Admin/assets/i/favicon.png">
  ...
  <div class="am-g myapp-login">
	<div class="myapp-login-logo-block  tpl-login-max">
		<div class="myapp-login-logo-text">
			<div class="myapp-login-logo-text">
				Amaze UI<span> 登陆</span> <i class="am-icon-skyatlas"></i>
		...
		<div class="am-u-sm-10 login-am-center">
			<form class="am-form" action="Login1" method="post" enctype="multipart/form-data">
				<fieldset>
					<div class="am-form-group" >
						<input type="email" name="name" class="" id="doc-ipt-email-1" placeholder="请输入账号">
					</div>

					<div class="am-form-group">
						<input type="password" name="password" id="doc-ipt-pwd-1" placeholder="请输入密码">
					</div>
